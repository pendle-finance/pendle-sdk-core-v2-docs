...
Test account info: {
  ...
  ethBalance: '9999.980442043336624783'
}
```
...
```
[
  BigNumber { value: "2471698683687129010" },
  BigNumber { value: "2141486721870700" },
  netLpOut: BigNumber { value: "2471698683687129010" },
  netSyFee: BigNumber { value: "2141486721870700" }
]
```
...
```
{
  data: '',
...
[
  ...
  BigNumber { value: "2469224513304758193" },
  {
    guessMin: BigNumber { value: "1046679331521556483" },
    guessMax: BigNumber { value: "1059264654145062172" },
    guessOffchain: BigNumber { value: "1048776885292140765" },
    maxIteration: 7,
...
{
  netLpOut: BigNumber { value: "2471698683687129010" },
  priceImpact: BigNumber { value: "28624805573866" }
}
```
