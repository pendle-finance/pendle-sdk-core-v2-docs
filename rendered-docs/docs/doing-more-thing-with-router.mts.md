...
Test account info: {
  ...
  ethBalance: '9999.981947658658254751'
}
```
...
```
{ estimatedGasConsumption: BigNumber { value: "439255" } }
```
...
```
[
  BigNumber { value: "2472118456219742392" },
  BigNumber { value: "2152111149020885" },
  netLpOut: BigNumber { value: "2472118456219742392" },
  netSyFee: BigNumber { value: "2152111149020885" }
]
```
...
```
{
  data: '',
...
[
  ...
  BigNumber { value: "2469643865645066429" },
  {
    guessMin: BigNumber { value: "1051250253938021507" },
    guessMax: BigNumber { value: "1063890537552506736" },
    guessOffchain: BigNumber { value: "1053356967873769046" },
    maxIteration: 7,
...
{
  netLpOut: BigNumber { value: "2472118456219742392" },
  priceImpact: BigNumber { value: "28795151166474" }
}
```
...
```
{
  ...
  gasEstimation: BigNumber { value: "439255" },
  extractedParams: [
    '0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266',
    '0xc374f7ec85f8c7de3207a10bb1978ba104bda3b2',
    BigNumber { value: "2469643865645066429" },
